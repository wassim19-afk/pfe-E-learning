            ...
            <div className="flex gap-3">
                ...
                <div className="relative ">
                    ...
                    <ClickOutHandler onClickOut={handleClickOutsideDropdown}>
                        <div className="relative">
                            {dropdownOpen && (
                                <div className="absolute -right-6 bg-white  shadow-md shadow-gray-500 p-3 rounded-sm border-gray-100 w-52">
                                    <a href="" className="flex gap-3 py-2 my-2 hover:bg-blue-500 hover:text-white -mx-4 px-4 rounded-md rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
